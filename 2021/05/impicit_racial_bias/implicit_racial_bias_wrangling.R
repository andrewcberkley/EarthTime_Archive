...
wide_final$iso2[wide_final$iso2 == "AL"] <-  "ALB"
wide_final$iso2[wide_final$iso2 == "AD"] <-  "AND"
wide_final$iso2[wide_final$iso2 == "AT"] <-  "AUT"
wide_final$iso2[wide_final$iso2 == "BY"] <-  "BLR"
wide_final$iso2[wide_final$iso2 == "BE"] <-  "BEL"
wide_final$iso2[wide_final$iso2 == "BA"] <-  "BIH"
wide_final$iso2[wide_final$iso2 == "BG"] <-  "BGR"
wide_final$iso2[wide_final$iso2 == "HR"] <-  "HRV"
wide_final$iso2[wide_final$iso2 == "CZ"] <-  "CZE"
wide_final$iso2[wide_final$iso2 == "DK"] <-  "DNK"
wide_final$iso2[wide_final$iso2 == "EE"] <-  "EST"
wide_final$iso2[wide_final$iso2 == "FI"] <-  "FIN"
wide_final$iso2[wide_final$iso2 == "FR"] <-  "FRA"
wide_final$iso2[wide_final$iso2 == "DE"] <-  "DEU"
wide_final$iso2[wide_final$iso2 == "GR"] <-  "GRC"
wide_final$iso2[wide_final$iso2 == "HU"] <-  "HUN"
wide_final$iso2[wide_final$iso2 == "IS"] <-  "ISL"
wide_final$iso2[wide_final$iso2 == "IE"] <-  "IRL"
wide_final$iso2[wide_final$iso2 == "IT"] <-  "ITA"
wide_final$iso2[wide_final$iso2 == "LV"] <-  "LVA"
wide_final$iso2[wide_final$iso2 == "LI"] <-  "LIE"
wide_final$iso2[wide_final$iso2 == "LT"] <-  "LTU"
wide_final$iso2[wide_final$iso2 == "LU"] <-  "LUX"
wide_final$iso2[wide_final$iso2 == "MT"] <-  "MLT"
wide_final$iso2[wide_final$iso2 == "MD"] <-  "MDA"
wide_final$iso2[wide_final$iso2 == "MC"] <-  "MCO"
wide_final$iso2[wide_final$iso2 == "ME"] <-  "MNE"
wide_final$iso2[wide_final$iso2 == "MK"] <-  "MKD"
wide_final$iso2[wide_final$iso2 == "AN"] <-  "ANT"
wide_final$iso2[wide_final$iso2 == "NL"] <-  "NLD"
wide_final$iso2[wide_final$iso2 == "NO"] <-  "NOR"
wide_final$iso2[wide_final$iso2 == "PL"] <-  "POL"
wide_final$iso2[wide_final$iso2 == "PT"] <-  "PRT"
wide_final$iso2[wide_final$iso2 == "RO"] <-  "ROU"
wide_final$iso2[wide_final$iso2 == "RU"] <-  "RUS"
wide_final$iso2[wide_final$iso2 == "SM"] <-  "SMR"
wide_final$iso2[wide_final$iso2 == "RS"] <-  "RKS"
wide_final$iso2[wide_final$iso2 == "SK"] <-  "SVK"
wide_final$iso2[wide_final$iso2 == "SI"] <-  "SVN"
wide_final$iso2[wide_final$iso2 == "ES"] <-  "ESP"
wide_final$iso2[wide_final$iso2 == "SE"] <-  "SWE"
wide_final$iso2[wide_final$iso2 == "CH"] <-  "CHE"
wide_final$iso2[wide_final$iso2 == "UA"] <-  "UKR"
