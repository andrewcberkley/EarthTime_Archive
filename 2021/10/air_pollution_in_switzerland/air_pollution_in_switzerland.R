...
df3 <- df2[-c(1:6,555),]
colnames(df3) <- c("Date","Bern-Bollwerk","Lausanne-Cesar-Roux","Lugano-Universita","Zurich-Kaserne","Basel-Binningen","Dubendorf-Empa","Harkingen-A1","Sion-Aeroport-A9","Magadino-Cadenazzo","Payerne","Tanikon","Beromunster","Rigi-Seebodenalp","Jungfraujoch")
...
station_location <- data.table(name = c("Bern-Bollwerk","Lausanne-Cesar-Roux","Lugano-Universita","Zurich-Kaserne","Basel-Binningen","Dubendorf-Empa","Harkingen-A1","Sion-Aeroport-A9","Magadino-Cadenazzo","Payerne","Tanikon","Beromunster","Rigi-Seebodenalp","Jungfraujoch"), stationLat = c(46.948, 46.5197, 46.0037, 47.3769, 47.5596, 47.3971, 47.3073, 46.2227, 46.1464, 46.822, 47.4796, 47.2064, 47.056, 46.5483), stationLong = c(7.4474, 6.6323, 8.9511, 8.5417, 7.5886, 8.618, 7.819, 7.3379, 8.8519, 6.9406, 8.9053, 8.1916, 8.4852, 7.9806))
